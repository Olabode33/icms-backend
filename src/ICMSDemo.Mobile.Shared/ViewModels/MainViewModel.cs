...
using MvvmHelpers;
using ICMSDemo.Authorization.Users.Profile;
using ICMSDemo.Authorization.Users.Profile.Dto;
using ICMSDemo.Commands;
using ICMSDemo.Core.Threading;
using ICMSDemo.Models.NavigationMenu;
using ICMSDemo.Services.Navigation;
...
using ICMSDemo.Dto;
using ICMSDemo.Extensions;
using ICMSDemo.Localization;
using ICMSDemo.UI;
using ICMSDemo.UI.Assets;
using ICMSDemo.Views;
using DependencyResolver = ICMSDemo.Core.Dependency.DependencyResolver;
...
namespace ICMSDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ICMSDemo";
