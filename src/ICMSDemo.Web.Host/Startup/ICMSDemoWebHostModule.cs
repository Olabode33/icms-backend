...
namespace ICMSDemo.Web.Startup
{
    ...
    public class ICMSDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ICMSDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ICMSDemoWebHostModule).GetAssembly());
        }
