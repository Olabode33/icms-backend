...
namespace ICMSDemo.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Host.TopStats,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            WidgetViewDefinitions.Add(ICMSDemoDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
                    ICMSDemoDashboardCustomizationConsts.Widgets.Host.RecentTenants,
