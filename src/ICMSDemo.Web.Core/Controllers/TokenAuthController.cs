...
using ICMSDemo.Web.Authentication.JwtBearer;
using ICMSDemo.Web.Authentication.TwoFactor;
using ICMSDemo.Web.Models.TokenAuth;
using ICMSDemo.Authorization.Impersonation;
...
using ICMSDemo.Web.Authentication.External;
using ICMSDemo.Web.Common;

namespace ICMSDemo.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : ICMSDemoControllerBase
    {
