...
namespace ICMSDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(ICMSDemoWebCoreModule)
    )]
    public class ICMSDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ICMSDemoWebFrontEndModule(IWebHostEnvironment env, ICMSDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ICMSDemoWebFrontEndModule).GetAssembly());
        }
    }
}
