...
using ICMSDemo.Url;
using ICMSDemo.Web.Public.Startup;
using ICMSDemo.Web.Session;

namespace ICMSDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ICMSDemoViewComponent
    {
