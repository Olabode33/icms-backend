...
{
    public class SubscriptionPaymentRepository : ICMSDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ICMSDemoDbContext> dbContextProvider)
