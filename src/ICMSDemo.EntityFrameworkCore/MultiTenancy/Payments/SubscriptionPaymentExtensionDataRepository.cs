...
using ICMSDemo.EntityFrameworkCore.Repositories;

namespace ICMSDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ICMSDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ICMSDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
