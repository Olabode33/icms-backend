...
namespace ICMSDemo.Migrations
{
    ...
    [Migration("20200906200757_Udpated_KRI_withBO")]
    partial class Udpated_KRI_withBO
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICMSDemo.DataLists.DataList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ICMSDemo.ExceptionIncidents.ExceptionIncident", b =>
                {
                    ...
                    b.Property<string>("RaisedByClosureComments")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid?>("WorkingPaperFkId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WorkingPaperFkId");

                    b.ToTable("ExceptionIncidents");
                });

            modelBuilder.Entity("ICMSDemo.ExceptionIncidents.ExceptionIncidentColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ExceptionTypeColumnId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExceptionTypeColumnId");

                    b.ToTable("ExceptionIncidentColumns");
                });
            ...
            modelBuilder.Entity("ICMSDemo.ExceptionTypeColumns.ExceptionTypeColumn", b =>
                {
                    ...
                    b.ToTable("ExceptionTypeColumns");
                });

            modelBuilder.Entity("ICMSDemo.ExceptionTypes.ExceptionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("Remediation")
                        .HasColumnType("int");

                    b.Property<int>("Severity")
                        .HasColumnType("int");

                    b.Property<int?>("TargetRemediation")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ICMSDemo.KeyRiskIndicators.KeyRiskIndicator", b =>
                {
                    ...
                    b.Property<string>("DataInputMethod")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ICMSDemo.LibraryControls.LibraryControl", b =>
                {
                    ...
                    b.Property<string>("InformationProcessingObjectives")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ICMSDemo.LibraryRisks.LibraryRisk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ICMSDemo.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ICMSDemo.Projects.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ICMSDemo.Risks.Risk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ICMSDemo.TestingTemplates.TestingAttrribute", b =>
                {
                    ...
                    b.ToTable("TestingAttrributesList");
                });

            modelBuilder.Entity("ICMSDemo.TestingTemplates.TestingTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("DepartmentRiskControlId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DepartmentRiskControlId");
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ICMSDemo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ICMSDemo.DepartmentRiskControls.DepartmentRiskControl", b =>
                {
                    b.HasOne("ICMSDemo.Controls.Control", "ControlFk")
                        .WithMany()
            ...
            modelBuilder.Entity("ICMSDemo.ExceptionIncidents.ExceptionIncident", b =>
                {
                    ...
                    b.HasOne("ICMSDemo.Authorization.Users.User", "RaisedByFk")
                        .WithMany()
                        .HasForeignKey("RaisedById");

                    b.HasOne("ICMSDemo.WorkingPapers.WorkingPaper", "WorkingPaperFk")
                        .WithMany()
                        .HasForeignKey("WorkingPaperFkId");
                });

            modelBuilder.Entity("ICMSDemo.ExceptionIncidents.ExceptionIncidentColumn", b =>
                {
                    b.HasOne("ICMSDemo.ExceptionIncidents.ExceptionIncident", "ExceptionIncidentFk")
                        .WithMany()
                        .HasForeignKey("ExceptionIncidentId");

                    b.HasOne("ICMSDemo.ExceptionTypeColumns.ExceptionTypeColumn", "ExceptionTypeColumnFk")
                        .WithMany()
                        .HasForeignKey("ExceptionTypeColumnId");
                });
            ...
            modelBuilder.Entity("ICMSDemo.KeyRiskIndicators.KeyRiskIndicator", b =>
                {
                    b.HasOne("ICMSDemo.BusinessObjectives.BusinessObjective", "BusinessObjectiveFk")
                        .WithMany()
            ...
            modelBuilder.Entity("ICMSDemo.Projects.Project", b =>
                {
                    b.HasOne("Abp.Organizations.OrganizationUnit", "ControlUnitFk")
                        .WithMany()
                        .HasForeignKey("ControlUnitId");
            ...
            modelBuilder.Entity("ICMSDemo.TestingTemplates.TestingAttrribute", b =>
                {
                    b.HasOne("ICMSDemo.TestingTemplates.TestingTemplate", "TestingTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("ICMSDemo.TestingTemplates.TestingTemplate", b =>
                {
                    b.HasOne("ICMSDemo.ProcessRiskControls.ProcessRiskControl", "DepartmentRiskControlFk")
                        .WithMany()
            ...
            modelBuilder.Entity("ICMSDemo.WorkingPapers.WorkingPaperDetail", b =>
                {
                    ...
                    b.HasOne("ICMSDemo.WorkingPapers.WorkingPaper", "WorkinPaperFK")
                        .WithMany()
                        .HasForeignKey("WorkingPaperId");
                });
            ...
            modelBuilder.Entity("ICMSDemo.Departments.Department", b =>
                {
                    ...
                    b.HasOne("Abp.Organizations.OrganizationUnit", "SupervisingUnit")
                        .WithMany()
                        .HasForeignKey("SupervisingUnitId");
