...
using ICMSDemo.Core.Base;
using ICMSDemo.Core.Extensions;
using ICMSDemo.Dto;
using ICMSDemo.Types;

namespace ICMSDemo.Queries
{
    public class OrganizationUnitQuery : ICMSDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
