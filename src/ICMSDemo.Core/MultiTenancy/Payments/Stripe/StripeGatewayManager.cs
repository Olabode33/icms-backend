...
{
    public class StripeGatewayManager : ICMSDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ICMSDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ICMSDemoConsts.Currency;
        }
