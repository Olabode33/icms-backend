...
using ICMSDemo.MultiTenancy.Demo;
...
namespace ICMSDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ICMSDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
