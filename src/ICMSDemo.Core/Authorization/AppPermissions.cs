namespace ICMSDemo.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_ExceptionIncidents_Delete = "Pages.ExceptionIncidents.Delete";

        public const string Pages_TestingTemplates = "Pages.TestingTemplates";
        public const string Pages_TestingTemplates_Create = "Pages.TestingTemplates.Create";
        ...
        public const string Pages_ExceptionTypes_Edit = "Pages.ExceptionTypes.Edit";
        public const string Pages_ExceptionTypes_Delete = "Pages.ExceptionTypes.Delete";

        public const string Pages_Controls = "Pages.Controls";
        public const string Pages_Controls_Create = "Pages.Controls.Create";
        public const string Pages_Controls_Edit = "Pages.Controls.Edit";
        public const string Pages_Controls_Delete = "Pages.Controls.Delete";
