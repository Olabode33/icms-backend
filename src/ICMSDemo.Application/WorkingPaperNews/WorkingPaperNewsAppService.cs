...
namespace ICMSDemo.WorkingPaperNews
{
    ...
    public class WorkingPaperNewsAppService : ICMSDemoAppServiceBase, IWorkingPaperNewsAppService
    {
		 ...
		 private readonly IRepository<User,long> _lookup_userRepository;
		  ...
		  public WorkingPaperNewsAppService(IRepository<WorkingPaper, Guid> workingPaperNewRepository , IRepository<TestingTemplate, int> lookup_testingTemplateRepository, IRepository<OrganizationUnit, long> lookup_organizationUnitRepository, IRepository<User, long> lookup_userRepository) 
		  {
		...
		_lookup_userRepository = lookup_userRepository;
         ...
         {
            var workingPaperNew = ObjectMapper.Map<WorkingPaper>(input);
