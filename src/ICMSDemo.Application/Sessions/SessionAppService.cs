...
{
    public class SessionAppService : ICMSDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = ICMSDemoConsts.Currency,
                    CurrencySign = ICMSDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ICMSDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
