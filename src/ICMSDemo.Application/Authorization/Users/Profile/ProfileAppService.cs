...
using ICMSDemo.Authentication.TwoFactor.Google;
using ICMSDemo.Authorization.Users.Dto;
using ICMSDemo.Authorization.Users.Profile.Cache;
using ICMSDemo.Authorization.Users.Profile.Dto;
using ICMSDemo.Friendships;
using ICMSDemo.Gdpr;
using ICMSDemo.Identity;
using ICMSDemo.Net.Sms;
using ICMSDemo.Security;
using ICMSDemo.Storage;
using ICMSDemo.Timing;

namespace ICMSDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ICMSDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("ICMSDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("ICMSDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
