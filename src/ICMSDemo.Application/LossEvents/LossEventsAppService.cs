...
namespace ICMSDemo.LossEvents
{
    ...
    public class LossEventsAppService : ICMSDemoAppServiceBase, ILossEventsAppService
    {
		 ...
		 private readonly IRepository<OrganizationUnit,long> _lookup_organizationUnitRepository;
		  ...
		  public LossEventsAppService(IRepository<LossEvent> lossEventRepository, ILossEventsExcelExporter lossEventsExcelExporter , IRepository<User, long> lookup_userRepository, IRepository<OrganizationUnit, long> lookup_organizationUnitRepository) 
		  {
		...
		_lookup_organizationUnitRepository = lookup_organizationUnitRepository;
		 ...
		 public async Task<PagedResultDto<GetLossEventForViewDto>> GetAll(GetAllLossEventsInput input)
         {
			...
			var filteredLossEvents = _lossEventRepository.GetAll()
						...
						.WhereIf(input.LossTypeFilter.HasValue && input.LossTypeFilter > -1, e => e.LossType == lossTypeFilter)
