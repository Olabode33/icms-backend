...
using ICMSDemo.Auditing.Exporting;
using ICMSDemo.Authorization;
using ICMSDemo.Authorization.Users;
using ICMSDemo.Dto;
using ICMSDemo.EntityHistory;
using EntityHistoryHelper = ICMSDemo.EntityHistory.EntityHistoryHelper;

namespace ICMSDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ICMSDemoAppServiceBase, IAuditLogAppService
    {
