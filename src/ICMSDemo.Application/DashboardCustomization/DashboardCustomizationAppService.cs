...
using ICMSDemo.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace ICMSDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ICMSDemoAppServiceBase, IDashboardCustomizationAppService
    {
