...
namespace ICMSDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ICMSDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ICMSDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(ICMSDemoConsts.ConnectionStringName).Value.ToString();
        }
