...
using ICMSDemo.MultiTenancy.HostDashboard;
...
namespace ICMSDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ICMSDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
